...
/**
 * 该文件来自 https://android.googlesource.com/platform/packages/apps/Calendar/+/master/src/com/android/calendar/ExpandableTextView.java
 */
...
//        mExpandDrawable = getResources().getDrawable(R.drawable.ic_expand);
//        mCollapseDrawable = getResources().getDrawable(R.drawable.ic_collapse);
        
        TypedArray a=context.obtainStyledAttributes(attrs, R.styleable.ExpandableTextView, 0, 0);
        
        mMaxCollapsedLines = a.getInt(R.styleable.ExpandableTextView_maxCollapsedLines, Integer.MAX_VALUE);
    ...
    public void setText(CharSequence text) {
        ...
        mTv.setText(text);
        //this.setVisibility(text.length() == 0 ? View.GONE : View.VISIBLE);
    }
