...
public class TestFragment extends BaseTabFragment implements OnStarFeedChangedListener {
...
//        ((AppCompatActivity)getActivity()).getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        mRefreshLayou = root.findViewById(R.id.refresh_layout);
        ...
        mRefreshLayou.setOnRefreshLoadmoreListener(new OnRefreshLoadmoreListener() {
            @Override
    ...
    public void onStarFeedAdded(Feed feed) {
        mFeedAdapter.updateStarFeedState(mRecyclerView, feed.getId());
    }
