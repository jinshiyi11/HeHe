...
import com.shuai.hehe.data.LoginStateChanged;
import com.shuai.hehe.data.UserInfo;
import com.shuai.hehe.protocol.BaseAutoReloginTask;
import com.shuai.hehe.protocol.ErrorInfo;
import com.shuai.hehe.protocol.LoginByAccountTask;
import com.shuai.hehe.protocol.LoginResult;
import com.shuai.hehe.protocol.ProtocolUtils;
import com.shuai.hehe.protocol.TokenInfo;
...
public class UserManager {
    ...
    public void logout(boolean byUser) {
        ...
        HeHeApplication.getRequestQueue().cancelAll(new RequestQueue.RequestFilter() {
    ...
    public void autoLogin() {
        ...
        RequestQueue requestQueue = HeHeApplication.getRequestQueue();
        request.setTag(this);
