...
import com.shuai.hehe.protocol.GetVerifyCodeTask;
import com.shuai.hehe.ui.ToastDialog;
...
public class GetVerifySmsButton extends Button implements SMSBroadcastReceiver.MessageListener {
	...
	private RequestQueue mRequestQueue= HeHeApplication.getRequestQueue();
